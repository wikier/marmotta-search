...
AjaxSolr.AbstractTextWidget = AjaxSolr.AbstractWidget.extend(
  ...
  {
  /**
   * The field for this queries are issued to.
   */
  field: 'q',
  /**
  ...
  set: function (q) {
    return this.changeSelection(function () {
      this.manager.store.get(this.field).val(q);
    });
  },
  ...
  clear: function () {
    return this.changeSelection(function () {
      this.manager.store.remove(this.field);
    });
  },
  ...
  changeSelection: function (func) {
    var before = this.manager.store.get(this.field).val();
    func.apply(this);
    var after = this.manager.store.get(this.field).val();
    if (after !== before) {
